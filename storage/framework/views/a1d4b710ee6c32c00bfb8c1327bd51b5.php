...
<div class="max-w-7xl mx-auto px-4 lg:px-6 py-8">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
        <div class="bg-slate-50 border border-slate-200 rounded-lg p-3 text-center">
            <div class="text-2xl font-bold text-slate-600"><?php echo e($pendingCount); ?></div>
        ...
        <div class="bg-blue-50 border border-blue-100 rounded-lg p-3 text-center">
            <div class="text-2xl font-bold text-blue-600"><?php echo e($underCount); ?></div>
        ...
        <div class="bg-orange-50 border border-orange-100 rounded-lg p-3 text-center">
            <div class="text-2xl font-bold text-orange-600"><?php echo e($actionCount); ?></div>
        ...
        <div class="bg-green-50 border border-green-100 rounded-lg p-3 text-center">
            <div class="text-2xl font-bold text-green-600"><?php echo e($approvedCount); ?></div>
    ...
    <?php echo $__env->make('partials.per-page', ['perPage' => $letters->perPage()], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    ?>
    <div class="bg-white rounded-xl border border-slate-100 shadow-sm p-5 mb-5 <?php echo e($ws['key'] === 'reupload_required' ? 'border-orange-200 ring-1 ring-orange-200' : ''); ?>">
        <div class="flex items-start justify-between flex-wrap gap-4">
            <div class="flex items-start gap-3">
                ...
                <div>
                    <div class="font-bold text-slate-900 text-sm"><?php echo e($letter->sanction_letter_no); ?></div>
                    <div class="text-slate-400 text-xs mt-0.5"><?php echo e($letter->subject); ?></div>
                    <div class="text-slate-400 text-xs mt-0.5">Sent: <?php echo e($letter->sent_at?->format('d M Y, h:i A') ?? $letter->created_at->format('d M Y')); ?></div>
                    <?php if($letter->canUpload()): ?>
                    <div class="text-xs mt-0.5 <?php echo e($ws['key'] === 'reupload_required' ? 'text-orange-500' : 'text-blue-600'); ?>">
                        <i class="fa-regular fa-hourglass-half mr-1"></i> Upload within: <strong><?php echo e($letter->uploadTimeRemaining()); ?></strong> (deadline <?php echo e($letter->uploadDeadline()->format('d M Y, h:i A')); ?>)
                    </div>
                    <?php elseif($letter->uploadDeadlinePassed() && $ws['key'] === 'pending'): ?>
                    ...
                    <div class="text-xs mt-0.5">
                        ...
                        <?php else: ?>
                        <span class="text-red-600 font-semibold">₹ <?php echo e(number_format($letter->processFeeAmount(), 2)); ?> — Pay to upload signed copy</span>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
                    <?php if(($letter->signed_pdf_upload_count ?? 0) > 0): ?>
                    <div class="text-slate-400 text-xs mt-0.5"><?php echo e($letter->signed_pdf_upload_count); ?> signed file(s) uploaded: <?php echo e($letter->signed_pdf_uploaded_at?->format('d M Y, h:i A')); ?></div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="flex items-center gap-2 mt-4 pt-3 border-t border-slate-50">
            <a href="<?php echo e(route('agent.sanctions.show', $letter)); ?>" class="text-xs font-semibold text-blue-600 hover:text-blue-800 flex items-center gap-1">
            ...
            <?php if($letter->processFeePaid()): ?>
                ...
                <a href="<?php echo e(route('agent.sanctions.show', $letter)); ?>#upload"
                   class="ml-auto text-xs font-semibold px-3 py-1.5 rounded-lg <?php echo e($ws['key'] === 'reupload_required' ? 'bg-orange-500 hover:bg-orange-600 text-white' : 'bg-blue-600 hover:bg-blue-700 text-white'); ?> flex items-center gap-1.5 transition">
                    ...
                    <?php echo e($ws['key'] === 'reupload_required' ? 'Re-upload Signed Copy' : 'Upload Signed Copy'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\laravel\agent-business-support\resources\views/agent/sanctions/index.blade.php ENDPATH**/ ?>