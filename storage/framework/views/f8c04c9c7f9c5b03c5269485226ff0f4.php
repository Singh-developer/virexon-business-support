    ...
    <div>
        ...
        <nav class="space-y-1.5 text-xs font-semibold p-4">
            ...
            <div class="flex flex-col space-y-2">
                <a href="<?php echo e(route('settings.profile')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-slate-600 hover:bg-slate-50 transition">
                    <svg class="w-4 h-4 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH E:\xampp\htdocs\laravel\agent-business-support\resources\views/partials/agent-sidebar.blade.php ENDPATH**/ ?>