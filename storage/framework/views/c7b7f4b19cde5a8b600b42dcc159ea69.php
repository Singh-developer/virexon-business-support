...
<body>
    ...
    <?php if(isset($checksum) && isset($params)): ?>
        <form method="POST" action="<?php echo e($environment === 'production'
            ? 'https://secure.paytmpayments.com/theia/api/v1/showCheckoutPage'
            : 'https://securestage.paytmpayments.com/theia/api/v1/showCheckoutPage'); ?>?mid=<?php echo e($params['MID']); ?>&orderId=<?php echo e($params['ORDER_ID']); ?>" id="paytm-checkout-form">
    ...
    <?php elseif(isset($txnToken)): ?>
        <form method="POST" action="<?php echo e($environment === 'production'
            ? 'https://secure.paytmpayments.com/theia/api/v1/showPaymentPage'
            : 'https://securestage.paytmpayments.com/theia/api/v1/showPaymentPage'); ?>?mid=<?php echo e($mid); ?>&orderId=<?php echo e($orderId); ?>" id="paytm-checkout-form">
            ...
            <input type="hidden" name="callbackUrl" value="<?php echo e($callbackUrl); ?>">
            <input type="hidden" name="website" value="<?php echo e($website); ?>">
        </form>
    <?php endif; ?>
...
<?php /**PATH E:\xampp\htdocs\laravel\agent-business-support\resources\views/payments/paytm-checkout.blade.php ENDPATH**/ ?>