...
<div class="panel" style="padding: 0; background: transparent; border: none; box-shadow: none;">
    <div class="filter-container">
        ...
        <div style="align-self: flex-end;">
            <?php if(!empty($filterAgent)): ?>
            <span style="font-size:13px;color:#1e40af;background:#eff6ff;border:1px solid #bfdbfe;border-radius:8px;padding:6px 12px;">
                👤 Agent: <strong><?php echo e($filterAgent->name); ?></strong> (<?php echo e($filterAgent->email); ?>)
            </span>
            <?php endif; ?>
            <?php if($status !== 'all' || !empty($filterAgent)): ?>
            <a href="<?php echo e(route('sanctions.index')); ?>" style="font-size:13px;color:#1557d6;text-decoration:none; margin-left:10px;">Reset</a>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div style="margin-bottom:12px;">
        <a href="<?php echo e(route('agents.edit', $filterAgent->id)); ?>" style="font-size:13px;color:#64748b;text-decoration:none;">← Back to Agent (<?php echo e($filterAgent->name); ?>)</a>
    </div>
    <?php endif; ?>
    ...
    <div class="table-wrap">
        <table id="sanctionsTable" class="display nowrap" style="width:100%">
            ...
            <tbody>
                ...
                ?>
                <tr data-created="<?php echo e($letter->created_at?->format('Y-m-d')); ?>" data-review="<?php echo e($ws['key']); ?>" data-sent="<?php echo e($isSent); ?>">
                    ...
                    <td data-order="<?php echo e($letter->created_at?->timestamp ?? 0); ?>"><?php echo e($letter->created_at?->format('d M Y') ?? '—'); ?></td>
                    <td>
