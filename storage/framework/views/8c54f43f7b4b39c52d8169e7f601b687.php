            ...
            <form method="POST" action="<?php echo e(route('settings.gateways.update', $gateway)); ?>">
                ...
                <div class="form-grid">
                    ...
                    <label>
                        ...
                        <input type="text" name="credentials[sandbox_website]" value="<?php echo e($gateway->credentials['sandbox_website'] ?? ''); ?>" placeholder="e.g. WEBSTAGING (Paytm) or website name">
                    </label>
                    <label>
                    ...
                    <label>
                        ...
                        <input type="text" name="credentials[production_website]" value="<?php echo e($gateway->credentials['production_website'] ?? ''); ?>" placeholder="e.g. DEFAULT (Paytm) or website name">
