    ...
    <div class="al-form">
        <form id="assertionForm" method="POST" action="<?php echo e(route('assertions.store')); ?>" enctype="multipart/form-data">
            ...
            <div class="field">
                ...
                <input id="title" name="title" type="text" required maxlength="200" value="<?php echo e(old('title', 'Assertion Letter')); ?>">
            </div>
            <div class="field">
                <label for="subject">Email Subject</label>
                <input id="subject" name="subject" type="text" required maxlength="255" value="<?php echo e(old('subject', 'Your Assertion Letter from Agent Business Support')); ?>">
            </div>
            <div class="field">
            ...
            <div class="field">
                ...
                <textarea id="body" name="body" required rows="8" placeholder="Write the letter body here. Use [[field_name]] for dynamic values."><?php echo e(old('body', '')); ?></textarea>
            ...
            <div class="field">
                ...
                <textarea id="notes" name="notes" rows="4" placeholder="Appears after Terms & Conditions..."><?php echo e(old('notes', '')); ?></textarea>
            </div>
            ...
            <div id="dynamicFieldsContainer">
                <div class="df-row" style="margin-bottom:8px">
                    ...
                    <div class="field">
                        <label for="title">Document Title</label>
                        <input id="title" name="title" type="text" required maxlength="200" value="<?php echo e(old('title', 'Advance Fund Sanction Letter')); ?>">
                    </div>
                    <div class="field">
                        <label for="subject">Email Subject</label>
            ...
            <div class="row-3">
                ...
                <div>
                    ...
                    <div class="field" style="margin-top: 36px;">
                        <label for="body">Body of the Letter</label>
                        <textarea id="body" name="body" required rows="6" placeholder="Write the letter body here. Use [[field_name]] for dynamic values."><?php echo e(old('body', '')); ?></textarea>
                        <div class="hint">Use <code>[[field_name]]</code> syntax for dynamic fields. e.g. <code>[[agent_name]]</code></div>
                    </div>
                    <div class="field">
                        <label for="notes">Notes (Optional)</label>
                ...
                <div>
                    ...
                    <input id="signature_company" name="signature_company" type="text" maxlength="180" value="<?php echo e(old('signature_company', 'Agent Business Support')); ?>">
                </div>
            </div>
...
function syncDfJson(){
    dynamicFieldsJson.value = JSON.stringify(dynamicFields);
}

function esc(s){if(s==null)return'';return String(s).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");}

document.getElementById('addDfBtn').addEventListener('click', function(){
    dynamicFields.push({key:'', value:''});
    renderDfRows();
});

document.getElementById('dfList').addEventListener('input', function(e){
...
document.getElementById('dfList').addEventListener('click', function(e){
