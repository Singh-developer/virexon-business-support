            ...
            <div class="hero-banner-bg relative rounded-2xl overflow-hidden shadow-md p-4 sm:p-6 lg:p-10 py-8 lg:py-12 text-white min-h-[240px] sm:min-h-[290px] flex items-center" style="background-color: #051329ba;">
                ...
                <div class="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 items-center w-full">
                    ...
                    <div class="lg:col-span-5 space-y-2">
                        ...
                        <h1 class="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white tracking-tight drop-shadow-md"><?php echo e(Auth::user()->name); ?>!</h1>
                    ...
                    <div class="lg:col-span-4 bg-[#051329] border border-white/10 rounded-2xl p-4 sm:p-6 shadow-2xl flex items-center space-x-3 sm:space-x-4">
                        ...
                        <div class="space-y-1 flex-1 min-w-0">
                            ...
                            <div class="text-2xl sm:text-3xl font-extrabold text-[#F59E0B] tracking-tight">₹<?php echo e(number_format($totalApproved, 0)); ?></div>
                            <div class="text-[10px] sm:text-xs text-slate-300 pt-1">
                                <span class="font-semibold">Remaining ₹<?php echo e(number_format($remainingLimit, 0)); ?></span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="bg-white rounded-xl p-5 shadow-sm border border-slate-200/80 flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-extrabold text-[#27AE60]">₹<?php echo e(number_format($totalApproved, 0)); ?></div>
                        <div class="text-xs text-slate-500 pt-0.5">
                            Remaining <span class="font-semibold text-slate-700">₹<?php echo e(number_format($remainingLimit, 0)); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl p-5 shadow-sm border border-slate-200/80 flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-extrabold text-[#1565C0]">₹<?php echo e(number_format($currentUsage, 0)); ?></div>
                        <div class="text-xs text-slate-500 pt-0.5">
                            <?php echo e($totalTransactions); ?> transaction(s) completed
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl p-5 shadow-sm border border-slate-200/80 flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-extrabold text-[#E65100]">₹<?php echo e(number_format($currentUsage, 0)); ?></div>
                        <div class="text-xs text-slate-500 pt-0.5">
                ...
                <div class="bg-white rounded-xl p-5 shadow-sm border border-slate-200/80 flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-extrabold text-[#6A1B9A]">₹<?php echo e(number_format($totalFees, 0)); ?></div>
                        <div class="text-xs text-slate-500 pt-0.5">
                            This month <span class="font-semibold text-slate-700">₹<?php echo e(number_format($monthlyFees, 0)); ?></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                ...
                <div class="bg-white rounded-xl p-5 shadow-sm border border-slate-200/80 flex flex-col justify-between space-y-4">
                        ...
                        <div class="grid grid-cols-12 gap-3 items-center">
                            <div class="col-span-7 space-y-3 text-xs">
                                <div>
                                    ...
                                    <div class="text-base font-extrabold text-slate-800">₹<?php echo e(number_format($totalApproved, 0)); ?></div>
                                </div>
                                <div>
                                    <div class="text-slate-500 font-medium">Total Disbursed</div>
                                    <div class="text-base font-extrabold text-[#27AE60]">₹<?php echo e(number_format($currentUsage, 0)); ?></div>
                                </div>
                                <div>
                                    <div class="text-slate-500 font-medium">Remaining Limit</div>
                                    <div class="text-base font-extrabold text-[#E65100]">₹<?php echo e(number_format($remainingLimit, 0)); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="col-span-5 flex justify-center">
                                <div class="relative w-24 h-24 flex items-center justify-center">
                                    <svg class="w-full h-full transform -rotate-90" viewBox="0 0 36 36">
                                        ...
                                        <path class="text-[#27AE60]" stroke-dasharray="<?php echo e($repaymentPercentage); ?>, 100" stroke-width="4" stroke-linecap="round" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                                    </svg>
                                    <div class="absolute inset-0 flex flex-col items-center justify-center text-center">
                                        <span class="text-base font-black text-slate-800 leading-none"><?php echo e($repaymentPercentage); ?>%</span>
                    ...
                    <div class="bg-[#F1F8E9] border border-emerald-200/70 rounded-xl p-3 flex items-start space-x-3 text-xs">
                        ...
                        <div class="space-y-1 flex-1">
                            ...
                            <a href="<?php echo e(route('payments.index')); ?>" class="inline-block font-bold text-[#0D6EFD] hover:underline">View Ledger →</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl p-5 shadow-sm border border-slate-200/80 flex flex-col justify-between space-y-4">
                    <div>
                        ...
                        <div class="space-y-3 text-xs">
                            <div class="flex items-center justify-between pb-1.5 border-b border-slate-50">
                                ...
                                <span class="font-extrabold text-slate-800 text-sm">₹<?php echo e(number_format($monthlySpent, 0)); ?></span>
                            </div>
                            <div class="flex items-center justify-between pb-1.5 border-b border-slate-50">
                                <span class="text-slate-500 font-medium">Monthly Fees/Commission</span>
                                <span class="font-extrabold text-slate-800 text-sm">₹<?php echo e(number_format($monthlyFees, 0)); ?></span>
                            </div>
                            <div class="flex items-center justify-between pt-1">
                                <span class="text-slate-700 font-bold">Total Earned (All Time)</span>
                                <span class="font-black text-slate-900 text-base">₹<?php echo e(number_format($totalFees, 0)); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-[#EBF3FE] border border-blue-200/80 rounded-xl p-3 flex items-center space-x-3 text-xs">
                        ...
                        <div>
                            ...
                            <div class="text-sm font-extrabold text-blue-950"><?php echo e(now()->format('d M Y')); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl p-5 shadow-sm border border-slate-200/80 space-y-3">
                    ...
                    <div class="space-y-2 text-xs">
                        ...
                        <a href="<?php echo e(route('payments.create')); ?>" class="flex items-center justify-between p-2.5 rounded-xl bg-[#E8F8F5] hover:bg-emerald-100/70 border border-emerald-100 transition group">
                        ...
                        <!-- Action 2: View Card -->
                        <?php if($card): ?>
                        <a href="<?php echo e(route('cards.show', $card)); ?>" class="flex items-center justify-between p-2.5 rounded-xl bg-[#EBF5FB] hover:bg-blue-100/70 border border-blue-100 transition group">
                            <div class="flex items-center space-x-3">
                        ...
                        <a href="<?php echo e(route('payments.index')); ?>" class="flex items-center justify-between p-2.5 rounded-xl bg-[#F4ECF7] hover:bg-purple-100/70 border border-purple-100 transition group">
                            <div class="flex items-center space-x-3">
                        ...
                        <a href="<?php echo e(route('tickets.create')); ?>" class="flex items-center justify-between p-2.5 rounded-xl bg-[#E0F2F1] hover:bg-teal-100/70 border border-teal-100 transition group">
                            <div class="flex items-center space-x-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-3 items-center">
                    ...
                    <div class="flex items-center space-x-3 p-2.5 rounded-lg bg-slate-50 border border-slate-100">
                        ...
                        <div class="space-y-0.5 overflow-hidden">
                            ...
                            <?php if(isset($documents['kyc']) && $documents['kyc']->status === 'verified'): ?>
                    ...
                    <div class="flex items-center space-x-3 p-2.5 rounded-lg bg-slate-50 border border-slate-100">
                        ...
                        <div class="space-y-0.5 overflow-hidden">
                            ...
                            <?php if(isset($documents['pan']) && $documents['pan']->status === 'verified'): ?>
                                <span class="inline-block px-2 py-0.5 rounded-full text-[10px] font-bold bg-[#E8F8F5] text-[#27AE60]">Compliant</span>
                            <?php else: ?>
                                <span class="inline-block px-2 py-0.5 rounded-full text-[10px] font-bold bg-[#FEF5E7] text-[#E65100]">Pending</span>
                            <?php endif; ?>
                    ...
                    <div class="flex items-center space-x-3 p-2.5 rounded-lg bg-slate-50 border border-slate-100">
                        ...
                        <div class="space-y-0.5 overflow-hidden">
                            ...
                            <?php if($detail && $detail->bank_name): ?>
                    ...
                    <div class="flex items-center space-x-3 p-2.5 rounded-lg bg-slate-50 border border-slate-100">
                        ...
                        <div class="space-y-0.5 overflow-hidden">
                            ...
                            <?php if(isset($documents['agreement']) && $documents['agreement']->status === 'verified'): ?>
                                <span class="inline-block px-2 py-0.5 rounded-full text-[10px] font-bold bg-[#E8F8F5] text-[#27AE60]">Compliant</span>
                            <?php else: ?>
                                <span class="inline-block px-2 py-0.5 rounded-full text-[10px] font-bold bg-[#FEF5E7] text-[#E65100]">Pending</span>
                            <?php endif; ?>
                    ...
                    <div class="flex items-center space-x-3 p-2.5 rounded-lg bg-slate-50 border border-slate-100">
                        ...
                        <div class="space-y-0.5 overflow-hidden">
                            ...
                            <?php if(isset($documents['undertaking']) && $documents['undertaking']->status === 'verified'): ?>
                    ...
                    ?>
                    <div class="<?php echo e($allCompliant ? 'bg-[#E8F8F5] border-emerald-200' : 'bg-[#FEF5E7] border-amber-200'); ?> border rounded-xl p-3 flex items-center space-x-3">
                        <div class="w-9 h-9 rounded-full <?php echo e($allCompliant ? 'bg-[#27AE60]' : 'bg-[#E65100]'); ?> text-white flex items-center justify-center shrink-0 shadow-md">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                            </svg>
                        </div>
                        <div>
                            <div class="font-extrabold <?php echo e($allCompliant ? 'text-emerald-950' : 'text-amber-950'); ?> text-xs">
                                <?php echo e($allCompliant ? 'You are Compliant' : 'Action Required'); ?>

                            </div>
                            <div class="text-[10px] <?php echo e($allCompliant ? 'text-emerald-800' : 'text-amber-800'); ?> font-medium">
                                <?php echo e($allCompliant ? 'All good to continue business with us.' : 'Complete pending items to proceed.'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\laravel\agent-business-support\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>