<?php if (isset($component)) { $__componentOriginal4cdf87ed4e4f0a7c848515848763b370 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4cdf87ed4e4f0a7c848515848763b370 = $attributes; } ?>
<?php $component = App\View\Components\LoanformLayout::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('loanform-layout'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\App\View\Components\LoanformLayout::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
    ...
    <div class="min-h-screen bg-gray-50 py-8 md:py-12 px-4 sm:px-6 lg:px-8 font-sans flex flex-col">
        ...
        <div class="max-w-6xl w-full mx-auto my-auto bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row items-stretch"
            x-data="{
                step: <?php echo e(session('step', old('current_step', 1))); ?>,
                maxStep: <?php echo e($unlockedStep ?? 1); ?>,
                isMarried: '<?php echo e(old('is_married', '0')); ?>',
                sameAsCurrent: false,
                otpSent: <?php echo e(session()->has('loan_form_otp') || $errors->has('otp') ? 'true' : 'false'); ?>,
                sendingOtp: false,
                ...
                async sendOtp() {
                    ...
                    try {
                        let response = await fetch('<?php echo e(route('agent.send-otp')); ?>', {
                            method: 'POST',
                            headers: {
            ...
            <div class="w-full md:w-3/5 p-6 md:p-12 relative bg-white h-full">
                ...
                <form x-ref="loanForm" method="POST" action="<?php echo e(route('register.agent.store')); ?>" enctype="multipart/form-data" novalidate>
                    <?php echo csrf_field(); ?>
                    ...
                    <div x-show="step === 1"
                        ...
                        <div class="space-y-4 md:space-y-5">
                            <div>
                                ...
                                <input type="text" name="name" value="<?php echo e(old('name', auth()->user()?->name)); ?>" class="w-full rounded-xl border-gray-300 bg-gray-50 p-3 focus:bg-white focus:ring-2 focus:ring-blue-500 transition">
...
<?php endif; ?>
                            ...
                            <div>
                                ...
                                <input type="email" name="email" value="<?php echo e(old('email', auth()->user()?->email)); ?>" class="w-full rounded-xl border-gray-300 bg-gray-50 p-3 focus:bg-white focus:ring-2 focus:ring-blue-500 transition">
                                <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
                    ...
                    <div x-show="step === 2"
                        ...
                        <div class="space-y-4 md:space-y-5">
                            <div>
                                ...
                                <input type="text" name="agent_id_number" value="<?php echo e(old('agent_id_number', auth()->user()?->detail?->agent_id_number)); ?>" class="w-full rounded-xl border-gray-300 bg-gray-50 p-3 focus:bg-white focus:ring-2 focus:ring-blue-500 transition uppercase tracking-wide">
                                <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('agent_id_number'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('agent_id_number')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5">
                                <div>
                                    ...
                                    <input type="text" name="father_name" value="<?php echo e(old('father_name', auth()->user()?->detail?->father_name)); ?>" class="w-full rounded-xl border-gray-300 bg-gray-50 p-3 focus:bg-white focus:ring-2 focus:ring-blue-500 transition">
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('father_name'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('father_name')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="mother_name" value="<?php echo e(old('mother_name', auth()->user()?->detail?->mother_name)); ?>" class="w-full rounded-xl border-gray-300 bg-gray-50 p-3 focus:bg-white focus:ring-2 focus:ring-blue-500 transition">
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('mother_name'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('mother_name')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5">
                                <div>
                                    ...
                                    <input type="date" name="date_of_birth" value="<?php echo e(old('date_of_birth', auth()->user()?->detail?->date_of_birth)); ?>" class="w-full rounded-xl border-gray-300 bg-gray-50 p-3 focus:bg-white focus:ring-2 focus:ring-blue-500 transition">
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
                                ...
                                <div>
                                    ...
                                    <?php $savedGender = old('gender', auth()->user()?->detail?->gender); ?>
                                    <select name="gender" class="w-full rounded-xl border-gray-300 bg-gray-50 p-3 focus:bg-white focus:ring-2 focus:ring-blue-500 transition">
                                        ...
                                        <option value="male" <?php echo e($savedGender == 'male' ? 'selected' : ''); ?>>Male</option>
                                        <option value="female" <?php echo e($savedGender == 'female' ? 'selected' : ''); ?>>Female</option>
                                        <option value="other" <?php echo e($savedGender == 'other' ? 'selected' : ''); ?>>Other</option>
                                    </select>
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
                    ...
                    <!-- STEP 3: Contact & Status -->
                    <div x-show="step === 3"
                        x-data="{ isMarried: '<?php echo e(old('is_married', auth()->user()?->detail?->is_married ?? '0')); ?>' }"
                        x-transition:enter="transition ease-out duration-300"
                        x-transition:enter-start="opacity-0 translate-y-4"
                        x-transition:enter-end="opacity-100 translate-y-0"
                        style="display: none;">
                        ...
                        <div class="space-y-4 md:space-y-5">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5">
                                <div>
                                    ...
                                    <input type="text" name="mobile" value="<?php echo e(old('mobile', auth()->user()?->detail?->mobile)); ?>" class="w-full rounded-xl border-gray-300 bg-gray-50 p-3 focus:bg-white focus:ring-2 focus:ring-blue-500 transition">
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('mobile'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="whatsapp_number" value="<?php echo e(old('whatsapp_number', auth()->user()?->detail?->whatsapp_number)); ?>" class="w-full rounded-xl border-gray-300 bg-gray-50 p-3 focus:bg-white focus:ring-2 focus:ring-blue-500 transition">
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('whatsapp_number'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('whatsapp_number')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
                            ...
                            <div class="pt-4 border-t border-gray-100">
                                ...
                                <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('is_married'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('is_married')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
                            ...
                            <div x-show="isMarried === '1'" x-transition class="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5 bg-blue-50 p-4 rounded-xl border border-blue-100" style="display: none;">
                                <div>
                                    ...
                                    <input type="text" name="spouse_name" value="<?php echo e(old('spouse_name', auth()->user()?->detail?->spouse_name)); ?>" class="w-full rounded-xl border-gray-300 bg-white p-3 focus:ring-2 focus:ring-blue-500 transition">
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('spouse_name'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('spouse_name')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="spouse_mobile" value="<?php echo e(old('spouse_mobile', auth()->user()?->detail?->spouse_mobile)); ?>" class="w-full rounded-xl border-gray-300 bg-white p-3 focus:ring-2 focus:ring-blue-500 transition">
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('spouse_mobile'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('spouse_mobile')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
                    ...
                    ?>
                    <div x-show="step === 4"
                        x-data="{ sameAsCurrent: <?php echo e(old('same_as_current', $isSame)); ?> }"
                        x-transition:enter="transition ease-out duration-300"
                        x-transition:enter-start="opacity-0 translate-y-4"
                        x-transition:enter-end="opacity-100 translate-y-0"
                        style="display: none;">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="bg-gray-50 p-4 md:p-5 rounded-xl border border-gray-200 shadow-sm">
                                ...
                                <div class="space-y-3 md:space-y-4">
                                    <textarea name="current_address" x-ref="curr_addr" @input="if(sameAsCurrent) $refs.perm_addr.value = $event.target.value" rows="2" class="w-full rounded-xl border-gray-300 bg-white p-3 focus:ring-2 focus:ring-blue-500 transition placeholder-gray-400" placeholder="Street Address / Flat / Building"><?php echo e(old('current_address', auth()->user()?->detail?->current_address)); ?></textarea>
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('current_address'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('current_address')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
                                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                        <input type="text" name="current_city" x-ref="curr_city" @input="if(sameAsCurrent) $refs.perm_city.value = $event.target.value" value="<?php echo e(old('current_city', auth()->user()?->detail?->current_city)); ?>" placeholder="City" class="w-full rounded-xl border-gray-300 bg-white p-3 focus:ring-2 focus:ring-blue-500 transition">
                                        <input type="text" name="current_state" x-ref="curr_state" @input="if(sameAsCurrent) $refs.perm_state.value = $event.target.value" value="<?php echo e(old('current_state', auth()->user()?->detail?->current_state)); ?>" placeholder="State" class="w-full rounded-xl border-gray-300 bg-white p-3 focus:ring-2 focus:ring-blue-500 transition">
                                        <input type="text" name="current_pincode" x-ref="curr_pin" @input="if(sameAsCurrent) $refs.perm_pin.value = $event.target.value" value="<?php echo e(old('current_pincode', auth()->user()?->detail?->current_pincode)); ?>" placeholder="Pincode" class="w-full rounded-xl border-gray-300 bg-white p-3 focus:ring-2 focus:ring-blue-500 transition">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div x-show="!sameAsCurrent" x-transition class="bg-gray-50 p-4 md:p-5 rounded-xl border border-gray-200 shadow-sm">
                                ...
                                <div class="space-y-3 md:space-y-4">
                                    <textarea name="permanent_address" x-ref="perm_addr" rows="2" class="w-full rounded-xl border-gray-300 bg-white p-3 focus:ring-2 focus:ring-blue-500 transition placeholder-gray-400" placeholder="Street Address / Flat / Building"><?php echo e(old('permanent_address', auth()->user()?->detail?->permanent_address)); ?></textarea>
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('permanent_address'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('permanent_address')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
                                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                        <input type="text" name="permanent_city" x-ref="perm_city" value="<?php echo e(old('permanent_city', auth()->user()?->detail?->permanent_city)); ?>" placeholder="City" class="w-full rounded-xl border-gray-300 bg-white p-3 focus:ring-2 focus:ring-blue-500 transition">
                                        <input type="text" name="permanent_state" x-ref="perm_state" value="<?php echo e(old('permanent_state', auth()->user()?->detail?->permanent_state)); ?>" placeholder="State" class="w-full rounded-xl border-gray-300 bg-white p-3 focus:ring-2 focus:ring-blue-500 transition">
                                        <input type="text" name="permanent_pincode" x-ref="perm_pin" value="<?php echo e(old('permanent_pincode', auth()->user()?->detail?->permanent_pincode)); ?>" placeholder="Pincode" class="w-full rounded-xl border-gray-300 bg-white p-3 focus:ring-2 focus:ring-blue-500 transition">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div x-show="step === 5"
                        x-data="{
            amount: <?php echo e(old('loan_amount', auth()->user()?->detail?->loan_amount ?? request('amount', 50000))); ?>,
            tenure: <?php echo e(old('loan_tenure', auth()->user()?->detail?->loan_tenure ?? request('tenure', 3))); ?>,
            rate: 9.5, 
            get emi() {
                        ...
                        <div class="space-y-6 bg-gray-50 p-5 md:p-6 rounded-xl border border-gray-200">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                                <div>
                                    ...
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('loan_amount'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('loan_amount')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
                                ...
                                <div>
                                    ...
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('loan_tenure'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('loan_tenure')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
                        ...
                        <div class="space-y-4 md:space-y-6 bg-gray-50 p-5 md:p-6 rounded-xl border border-gray-200">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                                <div>
                                    ...
                                    <input type="text" name="account_name" value="<?php echo e(old('account_name', auth()->user()?->detail?->account_name)); ?>" placeholder="e.g. John Doe" class="w-full rounded-xl border-gray-300 bg-white p-3 md:p-4 text-base md:text-lg focus:ring-2 focus:ring-blue-500 transition shadow-sm">
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('account_name'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('account_name')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="bank_name" value="<?php echo e(old('bank_name', auth()->user()?->detail?->bank_name)); ?>" placeholder="e.g. HDFC Bank" class="w-full rounded-xl border-gray-300 bg-white p-3 md:p-4 text-base md:text-lg focus:ring-2 focus:ring-blue-500 transition shadow-sm">
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('bank_name'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('bank_name')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                                <div>
                                    ...
                                    <input type="text" name="account_number" value="<?php echo e(old('account_number', auth()->user()?->detail?->account_number)); ?>" placeholder="0000 0000 0000" class="w-full rounded-xl border-gray-300 bg-white p-3 md:p-4 font-mono text-base md:text-lg tracking-widest focus:ring-2 focus:ring-blue-500 transition shadow-sm">
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('account_number'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('account_number')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="routing_number" value="<?php echo e(old('routing_number', auth()->user()?->detail?->routing_number)); ?>" placeholder="ABCD0123456" class="w-full rounded-xl border-gray-300 bg-white p-3 md:p-4 font-mono text-base md:text-lg uppercase tracking-widest focus:ring-2 focus:ring-blue-500 transition shadow-sm">
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('routing_number'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('routing_number')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
                        ...
                        <div class="space-y-6 md:space-y-8 bg-gray-50 p-5 md:p-6 rounded-xl border border-gray-200">
                            ...
                            <div x-data="{ photoPreview: null }" class="space-y-4 pb-6 border-b border-gray-200 last:border-0 last:pb-0">
                                <div>
                                    ...
                                    <input type="text" name="pan_number" value="<?php echo e(old('pan_number', auth()->user()?->detail?->pan_number)); ?>" placeholder="ABCDE1234F" maxlength="10" minlength="10" pattern="[A-Za-z]{5}[0-9]{4}[A-Za-z]{1}" class="w-full rounded-xl border-gray-300 bg-white p-3 md:p-4 font-mono text-base md:text-lg uppercase tracking-widest focus:ring-2 focus:ring-blue-500 transition shadow-sm">
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('pan_number'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('pan_number')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
                        ...
                        "
                            ...
                            <div x-data="{ photoPreview: null }" class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" name="aadhar_number" value="<?php echo e(old('aadhar_number', auth()->user()?->detail?->aadhar_number)); ?>" placeholder="0000 0000 0000" maxlength="12" minlength="12" class="w-full rounded-xl border-gray-300 bg-white p-3 md:p-4 font-mono text-base md:text-lg tracking-widest focus:ring-2 focus:ring-blue-500 transition shadow-sm">
                                    <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('aadhar_number'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('aadhar_number')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
                        ...
                        <div class="border-t border-gray-200 pt-6 mt-8">
                            ...
                            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('terms'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
 ...
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal4cdf87ed4e4f0a7c848515848763b370)): ?>
<?php $attributes = $__attributesOriginal4cdf87ed4e4f0a7c848515848763b370; ?>
<?php unset($__attributesOriginal4cdf87ed4e4f0a7c848515848763b370); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal4cdf87ed4e4f0a7c848515848763b370)): ?>
<?php $component = $__componentOriginal4cdf87ed4e4f0a7c848515848763b370; ?>
<?php unset($__componentOriginal4cdf87ed4e4f0a7c848515848763b370); ?>
<?php endif; ?><?php /**PATH E:\xampp\htdocs\laravel\agent-business-support\resources\views\auth\register-extended.blade.php ENDPATH**/ ?>