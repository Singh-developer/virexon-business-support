...
<div class="panel">
    ...
    <form method="POST" action="<?php echo e(route('agents.application-status', $agent)); ?>" style="display:flex; gap:10px; align-items:center; flex-wrap:wrap;">
        ...
        <a href="<?php echo e(route('sanctions.index', ['agent_id' => $agent->id])); ?>" class="btn secondary" style="text-decoration:none;display:inline-flex;align-items:center;gap:6px;">
...
<div class="panel">
    ...
    <form method="POST" action="<?php echo e(route('agents.update-details', $agent)); ?>">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PATCH'); ?>
        ...
        <div style="border:1px solid #e2e8f0; border-bottom:none; padding:16px;">
            <div class="form-grid">
                <label>Personal Email
                    <input name="personal_email" type="email" value="<?php echo e(old('personal_email', optional($detail)->personal_email)); ?>" style="color:#1e293b">
                </label>
                <label>Mobile
                    <input name="mobile" value="<?php echo e(old('mobile', optional($detail)->mobile)); ?>" style="color:#1e293b">
                </label>
                <label>WhatsApp Number
                    <input name="whatsapp_number" value="<?php echo e(old('whatsapp_number', optional($detail)->whatsapp_number)); ?>" style="color:#1e293b">
                </label>
                <label>Guardian / Father Name
                    <input name="guardian_name" value="<?php echo e(old('guardian_name', optional($detail)->guardian_name ?? optional($detail)->father_name)); ?>" style="color:#1e293b">
                </label>
                <label>Father Name
                    <input name="father_name" value="<?php echo e(old('father_name', optional($detail)->father_name)); ?>" style="color:#1e293b">
                </label>
                <label>Mother Name
                    <input name="mother_name" value="<?php echo e(old('mother_name', optional($detail)->mother_name)); ?>" style="color:#1e293b">
                </label>
                <label>Agent ID Number
                    <input name="agent_id_number" value="<?php echo e(old('agent_id_number', optional($detail)->agent_id_number)); ?>" style="color:#1e293b">
                </label>
                <label>Date of Birth
                    <input name="date_of_birth" type="date" value="<?php echo e($dobVal); ?>" style="color:#1e293b">
                </label>
                <label>Gender
                    <select name="gender" style="color:#1e293b">
                        <option value="">— Select —</option>
                        <option value="male" <?php if(old('gender', optional($detail)->gender) === 'male'): echo 'selected'; endif; ?>>Male</option>
                        <option value="female" <?php if(old('gender', optional($detail)->gender) === 'female'): echo 'selected'; endif; ?>>Female</option>
                        <option value="other" <?php if(old('gender', optional($detail)->gender) === 'other'): echo 'selected'; endif; ?>>Other</option>
                    </select>
                </label>
                <label>PAN Number
                    <input name="pan_number" value="<?php echo e(old('pan_number', optional($detail)->pan_number)); ?>" style="color:#1e293b; text-transform:uppercase;">
                </label>
                <label>Aadhar Number
                    <input name="aadhar_number" value="<?php echo e(old('aadhar_number', optional($detail)->aadhar_number)); ?>" style="color:#1e293b">
                </label>
                <label>Marital Status
                    <select name="is_married" id="is_married" style="color:#1e293b">
                        <option value="">— Select —</option>
                        <option value="0" <?php if((string) old('is_married', $marriedSelected) === '0'): echo 'selected'; endif; ?>>Single</option>
                        <option value="1" <?php if((string) old('is_married', $marriedSelected) === '1'): echo 'selected'; endif; ?>>Married</option>
                    </select>
                </label>
                <label>Spouse Name
                    <input name="spouse_name" value="<?php echo e(old('spouse_name', optional($detail)->spouse_name)); ?>" style="color:#1e293b">
                </label>
                <label>Spouse Mobile
                    <input name="spouse_mobile" value="<?php echo e(old('spouse_mobile', optional($detail)->spouse_mobile)); ?>" style="color:#1e293b">
                </label>
            </div>
        </div>
        ...
        <div style="border:1px solid #e2e8f0; border-bottom:none; padding:16px;">
            <div class="form-grid">
                <label style="grid-column:1/-1;">Current Address
                    <input name="current_address" value="<?php echo e(old('current_address', optional($detail)->current_address)); ?>" style="color:#1e293b">
                </label>
                <label>Address Line 2
                    <input name="address_line_2" value="<?php echo e(old('address_line_2', optional($detail)->address_line_2)); ?>" style="color:#1e293b">
                </label>
                <label>Current City
                    <input name="current_city" value="<?php echo e(old('current_city', optional($detail)->current_city)); ?>" style="color:#1e293b">
                </label>
                <label>Current State
                    <input name="current_state" value="<?php echo e(old('current_state', optional($detail)->current_state)); ?>" style="color:#1e293b">
                </label>
                <label>Current Pincode
                    <input name="current_pincode" value="<?php echo e(old('current_pincode', optional($detail)->current_pincode)); ?>" style="color:#1e293b">
                </label>
                <label style="grid-column:1/-1;">Permanent Address
                    <input name="permanent_address" value="<?php echo e(old('permanent_address', optional($detail)->permanent_address)); ?>" style="color:#1e293b">
                </label>
                <label>Permanent City
                    <input name="permanent_city" value="<?php echo e(old('permanent_city', optional($detail)->permanent_city)); ?>" style="color:#1e293b">
                </label>
                <label>Permanent State
                    <input name="permanent_state" value="<?php echo e(old('permanent_state', optional($detail)->permanent_state)); ?>" style="color:#1e293b">
                </label>
                <label>Permanent Pincode
                    <input name="permanent_pincode" value="<?php echo e(old('permanent_pincode', optional($detail)->permanent_pincode)); ?>" style="color:#1e293b">
                </label>
            </div>
        </div>
        ...
        <div style="border:1px solid #e2e8f0; border-bottom:none; padding:16px;">
            <div class="form-grid">
                <label>Account Holder
                    <input name="account_name" value="<?php echo e(old('account_name', optional($detail)->account_name)); ?>" style="color:#1e293b">
                </label>
                <label>Bank Name
                    <input name="bank_name" value="<?php echo e(old('bank_name', optional($detail)->bank_name)); ?>" style="color:#1e293b">
                </label>
                <label>Account Number
                    <input name="account_number" value="<?php echo e(old('account_number', optional($detail)->account_number)); ?>" style="color:#1e293b">
                </label>
                <label>IFSC / Routing No.
                    <input name="routing_number" value="<?php echo e(old('routing_number', optional($detail)->routing_number)); ?>" style="color:#1e293b">
                </label>
                <label>Account Type
                    <input name="account_type" value="<?php echo e(old('account_type', optional($detail)->account_type)); ?>" placeholder="Savings / Current" style="color:#1e293b">
                </label>
                <label>Branch
                    <input name="branch_name" value="<?php echo e(old('branch_name', optional($detail)->branch_name)); ?>" style="color:#1e293b">
                </label>
            </div>
        </div>
        ...
        <div style="border:1px solid #e2e8f0; border-bottom:none; padding:16px;">
            <div class="form-grid">
                <label>Fund Amount Requested (₹)
                    <input name="loan_amount" type="number" step="0.01" min="0" value="<?php echo e(old('loan_amount', optional($detail)->loan_amount)); ?>" style="color:#1e293b">
                </label>
                <label>Loan Tenure (months)
                    <input name="loan_tenure" type="number" min="1" max="360" value="<?php echo e(old('loan_tenure', optional($detail)->loan_tenure ?? 60)); ?>" style="color:#1e293b">
                </label>
                <label style="grid-column:1/-1;">Purpose of Advance
                    <input name="purpose_of_advance" value="<?php echo e(old('purpose_of_advance', optional($detail)->purpose_of_advance)); ?>" style="color:#1e293b">
                </label>
            </div>
        </div>
        ...
        <div style="border:1px solid #e2e8f0; border-radius:0 0 10px 10px; padding:16px;">
            <div id="references-wrap" style="display:grid; gap:0;">
                <?php $__empty_1 = true; $__currentLoopData = $refs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $ref): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="reference-row" data-ref-row style="padding:16px 0; border-top:1px dashed #e2e8f0; <?php if($loop->first): ?> border-top:none; padding-top:0; <?php endif; ?>">
                    <input type="hidden" name="references[<?php echo e($i); ?>][id]" value="<?php echo e($ref->id); ?>">
                    <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:12px;">
                        <div style="font-size:11px; font-weight:800; text-transform:uppercase; letter-spacing:.07em; color:#94a3b8;" data-ref-title>Reference #<?php echo e($i + 1); ?></div>
                        <button type="button" class="btn secondary" onclick="this.closest('[data-ref-row]').remove(); renumberReferences();">Remove</button>
                    </div>
                    <div class="form-grid">
                        <label>Name
                            <input name="references[<?php echo e($i); ?>][person_name]" value="<?php echo e(old("references.$i.person_name", $ref->person_name)); ?>" style="color:#1e293b">
                        </label>
                        <label>Mobile
                            <input name="references[<?php echo e($i); ?>][mobile]" value="<?php echo e(old("references.$i.mobile", $ref->mobile)); ?>" style="color:#1e293b">
                        </label>
                        <label style="grid-column:1/-1;">Company Agent ID
                            <input name="references[<?php echo e($i); ?>][company_agent_id]" value="<?php echo e(old("references.$i.company_agent_id", $ref->company_agent_id)); ?>" style="color:#1e293b">
                        </label>
                    </div>
                </div>
...
<script>
let refIndex = <?php echo e(max(1, $refs->count())); ?>;
