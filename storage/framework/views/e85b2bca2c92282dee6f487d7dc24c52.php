...
<div class="max-w-5xl mx-auto px-4 lg:px-6 py-8">
    ...
    <?php elseif($ws['key'] === 'under_review'): ?>
    ...
    <div class="bg-white rounded-xl border border-slate-100 shadow-sm p-5 mb-6">
        ...
        <div class="flex flex-wrap items-center gap-1 text-xs">
            ...
            <span class="text-slate-300">→</span>
            <span class="px-3 py-1.5 rounded-full font-semibold <?php echo e($letter->reviewed_at ? 'bg-green-50 text-green-700 border border-green-200' : 'bg-slate-50 text-slate-400 border border-slate-200'); ?>">
                ⚖ Reviewed
            </span>
            <span class="text-slate-300">→</span>
...
unset($__errorArgs, $__bag); ?>
        ...
        <?php elseif($ws['key'] === 'under_review' && $letter->signed_pdf_path): ?>
