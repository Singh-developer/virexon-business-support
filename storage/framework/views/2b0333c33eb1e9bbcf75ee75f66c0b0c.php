...
<style>
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="lg:w-2/3 bg-white border border-gray-200 rounded-lg p-6 lg:p-8 shadow-sm">
                ...
                <?php if(isset($alreadySubmitted) && $alreadySubmitted): ?>
                    <div class="bg-blue-50 border border-blue-200 text-blue-800 rounded-lg p-8 text-center shadow-sm">
                        <div class="w-16 h-16 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-3xl mx-auto mb-4">
                            ...
                            <?php elseif($status === 'form_received'): ?>
                        ...
                        <?php if($status === 'form_received'): ?>
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 justify-center">
                                <a href="<?php echo e(route('documents.index')); ?>" class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-lg transition">
                                    <i class="fa-solid fa-arrow-up-from-bracket"></i> Upload Documents Now →
                                </a>
                                <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center gap-2 bg-white hover:bg-gray-50 text-blue-700 border border-blue-300 font-medium py-3 px-6 rounded-lg transition">
                                    Go to Dashboard
                                </a>
                            </div>
                        <?php else: ?>
                ...
                <?php else: ?>
                <form method="POST" action="<?php echo e(route('register.agent.store')); ?>" id="agent-reg-form">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-8 border border-gray-100 rounded-lg p-5 js-mstep" data-mstep-title="Personal Information">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                            ...
                            <div>
                                ...
                                <input type="email" value="<?php echo e(auth()->user()->email); ?>" class="form-input bg-gray-50 text-gray-500 cursor-not-allowed" readonly disabled>
                            </div>
                            <div>
                                <label class="form-label">Personal Email ID <span class="req">*</span></label>
                                <input type="email" id="email" name="personal_email" value="<?php echo e(old('personal_email')); ?>" class="form-input" placeholder="Enter personal email" required>
                    ...
                    <div class="flex flex-col md:flex-row items-center justify-between gap-6 pt-4 border-t border-gray-200 js-mstep" data-mstep-title="Review & Submit">
                        <label class="flex items-start gap-3 text-xs text-gray-600 max-w-xl cursor-pointer">
                            ...
                            <span>I hereby declare that all the information provided above is true, correct and complete to the best of my knowledge. I have read and understood the <a href="<?php echo e(route('terms')); ?>" target="_blank" class="text-blue-600 hover:underline">terms and conditions</a> of Business Support Advance.</span>
                        </label>
    ...
    <script>
        window.__agentRegErrors = <?php echo json_encode($errors->keys(), 15, 512) ?>;
        (function () {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\laravel\agent-business-support\resources\views/auth/register-new.blade.php ENDPATH**/ ?>