...
<div class="doc-locked-wrap">
    ...
    <div class="doc-footer-actions">
        ...
        <div class="doc-footer-btns">
            <a href="<?php echo e(route('tickets.create')); ?>" class="doc-btn dark">Open Support Ticket</a>
            <a href="<?php echo e(route('dashboard')); ?>" class="doc-btn light">← Dashboard</a>
        </div>
    </div>

    <div class="doc-support">
        Need help? <a href="<?php echo e(route('tickets.create')); ?>">Contact support</a> · <a href="<?php echo e(route('dashboard')); ?>">Dashboard</a>
    </div>

    <!-- Bottom tab bar (UI parity with reference) -->
    <!-- <nav class="doc-bottomnav" aria-label="Primary">
        <a class="doc-bnav-item" href="<?php echo e(route('dashboard')); ?>">
        ...
        <a class="doc-bnav-item" href="<?php echo e(route('advances.index')); ?>">
        ...
        <a class="doc-bnav-item active" href="<?php echo e(route('documents.index')); ?>" aria-current="page">
        ...
        <a class="doc-bnav-item" href="<?php echo e(route('settings.profile')); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\laravel\agent-business-support\resources\views/documents/locked.blade.php ENDPATH**/ ?>