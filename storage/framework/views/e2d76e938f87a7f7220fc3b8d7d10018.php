                ...
                <ol class="relative border-l-2 border-slate-100 ml-3 space-y-6">
                    ...
                    <li class="ml-6">
                        <span class="absolute -left-3.5 w-7 h-7 rounded-full flex items-center justify-center ring-4 ring-white
                            <?php echo e(in_array($appStatus, ['form_received', 'approved']) ? 'bg-green-500' : 'bg-yellow-400'); ?>">
                            <?php if(in_array($appStatus, ['form_received', 'approved'])): ?>
                                <i class="fa-solid fa-check text-white text-xs"></i>
                            <?php else: ?>
                                <i class="fa-solid fa-clock text-white text-xs"></i>
                            <?php endif; ?>
                        </span>
                        <div class="<?php echo e(in_array($appStatus, ['form_received', 'approved']) ? 'bg-green-50 border-green-100' : 'bg-yellow-50 border-yellow-100'); ?> border rounded-xl px-4 py-3">
                            <div class="font-bold text-sm <?php echo e(in_array($appStatus, ['form_received', 'approved']) ? 'text-green-900' : 'text-yellow-900'); ?>">
                            ...
                            <div class="text-xs mt-0.5 <?php echo e(in_array($appStatus, ['form_received', 'approved']) ? 'text-green-700' : 'text-yellow-700'); ?>">Admin verifies your application and marks it as received.</div>
                        </div>
                    </li>
                    ...
                    <li class="ml-6">
                        <span class="absolute -left-3.5 w-7 h-7 rounded-full flex items-center justify-center ring-4 ring-white
                            <?php echo e(in_array($appStatus, ['form_received', 'approved']) ? 'bg-blue-500' : 'bg-slate-200'); ?>">
                            <?php if(in_array($appStatus, ['form_received', 'approved'])): ?>
                        ...
                        <div class="<?php echo e(in_array($appStatus, ['form_received', 'approved']) ? 'bg-blue-50 border-blue-200' : 'bg-slate-50 border-slate-100'); ?> border rounded-xl px-4 py-3">
                            <div class="font-bold text-sm <?php echo e(in_array($appStatus, ['form_received', 'approved']) ? 'text-blue-900' : 'text-slate-400'); ?>">
                                Upload Your Documents
                            </div>
                            <div class="text-xs mt-0.5 <?php echo e(in_array($appStatus, ['form_received', 'approved']) ? 'text-blue-700' : 'text-slate-400'); ?>">
                    ...
                    <li class="ml-6">
                        <span class="absolute -left-3.5 w-7 h-7 rounded-full flex items-center justify-center ring-4 ring-white
                            <?php echo e($appStatus === 'approved' ? 'bg-green-500' : 'bg-slate-200'); ?>">
...
<?php /**PATH E:\xampp\htdocs\laravel\agent-business-support\resources\views/documents/locked.blade.php ENDPATH**/ ?>