    ...
    <header class="bg-[#0B1727] text-white fixed top-0 left-0 right-0 z-50 border-b border-slate-800/80 shadow-md w-full" style="height: 60px;">
        <div class="w-full px-4 lg:px-6 h-full flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3 sm:space-x-4 lg:space-x-6 text-xs lg:text-sm">
                ...
                <div class="relative" id="agent-notif-btn">
                    <button class="relative p-2 rounded-lg hover:bg-slate-800 transition focus:outline-none">
                        ...
                        <span class="absolute top-0.5 right-0.5 bg-red-500 text-white text-[9px] font-bold w-4 h-4 rounded-full flex items-center justify-center border-2 border-[#0B1727]">
