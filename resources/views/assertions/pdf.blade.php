...
<div class="address-section">
    ...
    <strong>Agent ID:</strong> <span style="border-bottom:1px solid #ccc; padding-bottom:2px;">{{ $agentIdStr }}</span><br>
    <strong>Address:</strong> <span style="border-bottom:1px solid #ccc; padding-bottom:2px;">{{ $agentAddress }}</span>
</div>
...
<table class="details-table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="font-weight:bold;">₹{{ is_numeric($advanceAmount) ? number_format($advanceAmount, 2) : $advanceAmount }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>{{ $agent->detail?->account_number ?? 'As registered in system' }}</td>
        </tr>
        <tr>
...
<div class="notes-box">
    ...
    @if(!empty($notes))
        <br><br><strong>Additional Notes:</strong><br>{!! nl2br(e($notes)) !!}
    @endif
</div>
...
<table class="sig-table">
    <tr>
        ...
        <td class="sig-right">
            ...
            <div class="sig-row">
                <span class="sig-label" style="width:70px;">Agent Name</span> : <span class="sig-val" style="width:200px;text-align:center;"><strong>{{ $agent->name }}</strong></span>
            </div>
            <div class="sig-row">
                <span class="sig-label" style="width:70px;">Agent ID</span> : <span class="sig-val" style="width:200px;text-align:center;">{{ $agentIdStr }}</span>
            </div>
            ...
            <div class="sig-row" style="margin-top:10px;">
                <span class="sig-label" style="width:70px;">Date</span> : <span class="sig-val" style="width:200px;text-align:center;">{{ now()->format('d/m/Y') }}</span>
            </div>
        </td>
    </tr>
</table>
