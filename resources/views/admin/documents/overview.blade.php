...
<style>
    ...
    .ov-table th { text-align: left; font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: .05em; color: #94a3b8; padding: 10px 14px; border-bottom: 1px solid #e2e8f0; }
    .ov-table td { padding: 12px 14px; border-bottom: 1px solid #f1f5f9; vertical-align: middle; }
    .ov-table tbody tr:hover { background: #f8fafc; }
    .ov-agent-avatar { width: 34px; height: 34px; border-radius: 50%; background: #e0f2fe; color: #0369a1; display: inline-flex; align-items: center; justify-content: center; font-weight: 700; font-size: 13px; }
    .ov-pill { font-size: 11px; font-weight: 700; padding: 3px 10px; border-radius: 99px; white-space: nowrap; display: inline-block; }
    .ov-pill.green { background: #d1fae5; color: #065f46; border: 1px solid #a7f3d0; }
    .ov-pill.blue  { background: #dbeafe; color: #1e40af; border: 1px solid #bfdbfe; }
    .ov-pill.red   { background: #fee2e2; color: #991b1b; border: 1px solid #fecaca; }
    .ov-pill.slate { background: #f1f5f9; color: #475569; border: 1px solid #e2e8f0; }
    .ov-pill.amber { background: #ffedd5; color: #9a3412; border: 1px solid #fed7aa; }
    .ov-bar { height: 6px; border-radius: 99px; background: #e2e8f0; overflow: hidden; min-width: 90px; }
    .ov-bar > div { height: 100%; background: #22c55e; border-radius: 99px; }
    .ov-count { font-size: 11px; color: #64748b; margin-top: 3px; }
</style>
