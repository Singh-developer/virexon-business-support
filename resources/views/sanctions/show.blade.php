...
<div class="page-head">
    <div>
        ...
        <h1>{{ $letter->sanction_letter_no }}</h1>
        <p style="color:#64748b;font-size:14px;margin-top:5px">Details of the sent sanction letter.</p>
    </div>
    <div style="display:flex;gap:10px">
        <a href="{{ route('sanctions.download', $letter) }}" class="btn primary">Download PDF</a>
        <a href="{{ route('sanctions.index') }}" class="btn secondary">← Back</a>
    </div>
</div>
