...
<div class="p1">
    ...
    <table class="hdr">
        <tr>
            <td class="hdr-logo">
                <div class="logo-wrap">
                    <!-- <img src="{{ public_path('images/virexon-logo-dark.jpeg') }}" alt="Virexon Logo"> -->
    ...
    <div class="body-wrap">
        ...
        <table class="ref-row">
            <tr>
                ...
                <td class="right">Date :- {{ $sanctionDate }}</td>
            </tr>
        </table>

        <div class="recipient">
            <div>Mr. {{ $agent->name }}</div>
            <div>{{ (isset($guardian_relation) ? $guardian_relation : (isset($df['guardian_relation']) ? $df['guardian_relation'] : 'S/o')) . ':-' }} @if($guardian) {{ $guardian }} @endif</div>
            <div>Agent ID:- {{ $agentIdStr }}</div>
            <div>Address:- {{ $letterAddress }}</div>
        </div>
        ...
        <table class="details-table">
            ...
            <tbody>
                <tr class="alt"><td><strong>Agent Name</strong></td><td class="det">{{ $agent->name }}</td></tr>
                <tr><td><strong>Agent ID</strong></td><td class="det">{{ $agentIdStr }}</td></tr>
                <tr class="alt"><td><strong>Sanction Letter No.</strong></td><td class="det">{{ $sanctionLetterNo }}</td></tr>
                <tr><td><strong>Approved A/F Amount</strong></td><td class="det amt">{{ $fmt($approvedAmount) }}</td></tr>
                <tr class="alt"><td><strong>Disbursement Mode</strong></td><td class="det">{{ $disbursementMode }}</td></tr>
                <tr><td><strong>Process Fee</strong></td><td class="det">{{ $fmt($processFee) }}</td></tr>
                <tr><td><strong>Tenure</strong></td><td class="det">{{ $tenure }}</td></tr>
                <tr class="alt"><td><strong>Monthly Principal Settlement</strong></td><td class="det amt">{{ $fmt($monthlyPrincipal) }}</td></tr>
                <tr><td><strong>Monthly Portal &amp; Service Charges</strong></td><td class="det amt">{{ $fmt($monthlyCharges) }}</td></tr>
                <tr class="alt"><td><strong>Total Monthly Settlement</strong></td><td class="det amt">{{ $fmt($totalMonthly) }}</td></tr>
            </tbody>
        </table>
            ...
            <tr>
                <td>
                    <div class="stamp-box">
                        ...
                        <img class="stamp-sign" src="{{ $signature_image_url }}" alt="Signature">
                        @endif
                        <div class="stamp-sub">{{ $signature_name ?? 'Virexon' }}@if(!empty($signature_designation))<br>{{ $signature_designation }}@endif @if(!empty($signature_company))<br>{{ $signature_company }}@endif</div>
        ...
        <table style="width:100%;">
            <tr>
                ...
                <td style="text-align:right; vertical-align:bottom;">
                    <span class="rgt">({{ $agent->name }})&nbsp;&nbsp;Agent ID ({{ $agentIdStr }})</span>
                </td>
            </tr>
        </table>
    </div>
