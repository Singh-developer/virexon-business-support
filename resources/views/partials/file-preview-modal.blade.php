{{-- Shared signed-file preview popup (mobile-first file viewing).
     Usage: @include('partials.file-preview-modal') once per page, then call
     FilePreviewModal.open({url, name, downloadUrl, ext}) from your buttons.
     FilePreviewModal.usePopup() returns true on small screens (<= 768px). --}}
