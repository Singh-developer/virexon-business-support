                    ...
                    <div class="mb-8 border border-gray-100 rounded-lg p-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                            <div>
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" class="form-input" placeholder="Enter full name" required>
                            </div>
                            <div>
                                <label class="form-label">Father / Mother / Spouse Name <span class="req">*</span></label>
                                <input type="text" name="guardian_name" value="{{ old('guardian_name') }}" class="form-input" placeholder="Enter name" required>
                            </div>
                            <div>
                                <label class="form-label">Agent ID <span class="req">*</span></label>
                                <input type="text" name="agent_id_number" value="{{ old('agent_id_number') }}" class="form-input" placeholder="Enter Agent ID" required>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select name="is_married" class="form-input" required>
                                    ...
                                    <option value="0" @selected(old('is_married') === '0')>Single</option>
                                    <option value="1" @selected(old('is_married') === '1')>Married</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <div class="flex">
                                    ...
                                    <input type="text" name="mobile" value="{{ old('mobile') }}" class="form-input rounded-l-none" placeholder="Enter mobile number" required>
                                </div>
                            </div>
                            <div>
                                <label class="form-label">Official Email ID (Non-editable)</label>
                                <input type="email" value="{{ auth()->user()->email }}" class="form-input bg-gray-50 text-gray-500 cursor-not-allowed" readonly disabled>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" name="pan_number" value="{{ old('pan_number') }}" class="form-input" placeholder="Enter PAN number" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-8 border border-gray-100 rounded-lg p-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                            <div>
                                ...
                                <input type="text" name="current_address" value="{{ old('current_address') }}" class="form-input" placeholder="House No., Building, Street" required>
                            </div>
                            <div>
                                <label class="form-label">Address Line 2</label>
                                <input type="text" name="address_line_2" value="{{ old('address_line_2') }}" class="form-input" placeholder="Area / Landmark">
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                            <div>
                                <label class="form-label">City / District <span class="req">*</span></label>
                                <input type="text" name="current_city" value="{{ old('current_city') }}" class="form-input" placeholder="Enter city / district" required>
                            </div>
                            <div>
                                <label class="form-label">State <span class="req">*</span></label>
                                <input type="text" name="current_state" value="{{ old('current_state') }}" class="form-input" placeholder="Select State" required>
                            </div>
                            <div>
                                <label class="form-label">Pin Code <span class="req">*</span></label>
                                <input type="text" name="current_pincode" value="{{ old('current_pincode') }}" class="form-input" placeholder="Enter pin code" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-8 border border-gray-100 rounded-lg p-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                            <div>
                                ...
                                <input type="text" name="account_name" value="{{ old('account_name') }}" class="form-input" placeholder="Enter account holder name" required>
                            </div>
                            <div>
                                <label class="form-label">Bank Name <span class="req">*</span></label>
                                <input type="text" name="bank_name" value="{{ old('bank_name') }}" class="form-input" placeholder="Enter bank name" required>
                            </div>
                            <div>
                                <label class="form-label">Account Number <span class="req">*</span></label>
                                <input type="text" name="account_number" value="{{ old('account_number') }}" class="form-input" placeholder="Enter account number" required>
                            </div>
                            <div>
                                <label class="form-label">IFSC Code <span class="req">*</span></label>
                                <input type="text" name="routing_number" value="{{ old('routing_number') }}" class="form-input" placeholder="Enter IFSC code" required>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" name="branch_name" value="{{ old('branch_name') }}" class="form-input" placeholder="Enter branch name" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="loan_amount" value="{{ old('loan_amount') }}" class="form-input pl-8" placeholder="Enter amount" required max="500000">
                                </div>
                            ...
                            <div>
                                ...
                                <textarea name="purpose_of_advance" rows="2" class="form-input" placeholder="Briefly describe the purpose of advance" required maxlength="300">{{ old('purpose_of_advance') }}</textarea>
    ...
    <script>
        ...
        function sendOtp() {
            ...
            if (!emailInput || !emailInput.value) {
                alert('Please enter your personal email address first.');
                emailInput.focus();
                return;
            }
