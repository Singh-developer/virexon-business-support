...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $card = VirtualCard::firstOrCreate(['agent_id' => $agent->id], ['business_id' => $business->id, 'agent_id' => $agent->id, 'reference' => 'VC-DEMO-0001', 'cardholder_name' => $agent->name, 'status' => CardStatus::ACTIVE, 'card_limit' => 100000, 'daily_limit' => 20000, 'monthly_limit' => 80000, 'per_transaction_limit' => 20000, 'current_usage' => 12500, 'expiry_date' => now()->addYear(), 'created_by' => $admin->id, 'encrypted_pan' => encrypt('4111111111111111'), 'encrypted_cvv' => encrypt('123'), 'last4' => '1111', 'provider_card_id' => 'sandbox_card_001']);
